...
def search():
    ...
    if len(query) == 0:
      return jsonify(res)
    # BEGIN SOLUTION
    res=searchStemBody(query, titleInvertedIndex, anchorInvertedIndex,5,0.1,0.3)
    # END SOLUTION
    return jsonify(res)
...
def search_body():
    ...
    if len(query) == 0:
      return jsonify(res)
    # BEGIN SOLUTION
    #res=searchBody(query,   bodyInvertedIndex, bodyPostingPath, docWI, DL, titleDictId)
    res=searchBody(query)
    # END SOLUTION
    return jsonify(res)
...
def search_title():
    ...
    if len(query) == 0:
      return jsonify(res)
    # BEGIN SOLUTION
    res=binarySearch(query, titleInvertedIndex, titlePostingPath)
    # END SOLUTION
    return jsonify(res)
...
def search_anchor():
    ...
    if len(query) == 0:
      return jsonify(res)
    # BEGIN SOLUTION
    res=binarySearch(query, anchorInvertedIndex, anchorPostingPath)
    # END SOLUTION
    return jsonify(res)
...
def get_pagerank():
    ...
    for id in wiki_ids:
        try:
          res.append(float(pageRank[str(id)]))
        except:
          res.append(0)
